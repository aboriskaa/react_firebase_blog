import { Grid, Container, Typography, Box, MobileStepper, Paper, Button } from '@mui/material';
...
function About(theme) {
    ...
    return (
        <>
            <Container fixed>
                <Grid container spacing={2} mt='20px' mb='20px' sx={{}}>
                    <Grid item xs={12} md={12} sx={{}}>
                        ...
                        >
                            <Typography variant="h4" component="div">Hello, Dear friend!</Typography>
                            <Typography variant="h5" component="div">This is part of my React portfolio.</Typography>
                            <Typography variant="h5" component="div">Which stack is used here?</Typography>
                            <Box sx={{ maxWidth: 375, flexGrow: 1 }}>
                                ...
                                >
                                    <Typography sx={{
                                        color: 'primary.main'
                                    }} variant="h5" component="div">{steps[activeStep].label}
                                    </Typography>
                                </Paper>
